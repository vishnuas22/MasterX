# 🎨 MASTERX FRONTEND - COMPLETE FILE DOCUMENTATION (PART 6)
...
## 🏗️ LAYOUT COMPONENTS (Molecules)

### 44. `src/components/layout/Header.tsx` - Application Header
...
- ← Backend: `/api/auth/me` for user data

---

### 45. `src/components/layout/Sidebar.tsx` - Navigation Sidebar
...
- ✅ Active route indication (visual + ARIA)
- ✅ Keyboard navigation
- ✅ Focus management
...
**Connected Files:**
- ← `authStore.ts` (user stats)
- → All main app pages
- → Badge component
- ← Backend: `/api/v1/gamification/stats`

---


### 46. `src/components/layout/Footer.tsx` - Application Footer
...
### 47. `src/components/auth/LoginForm.tsx` - Login Form
...
**Connected Files:**
- ← `authStore.ts` (login function)
- → Input, Button components
- ← Backend: `POST /api/auth/login`

---

### 48. `src/components/auth/SignupForm.tsx` - Registration Form
