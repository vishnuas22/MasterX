          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center">
                ...
                <span className="text-sm font-mono">{performance.score}/100</span>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center">
                {performance.memory.isHigh && (
                  <AlertTriangle className="h-3 w-3 text-yellow-500 mr-1" />
                )}
                <span className="text-sm font-mono">
                  {performance.memory.current.toFixed(1)}MB
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center">
                {performance.render.isSmooth ? (
                  <CheckCircle className="h-3 w-3 text-green-500 mr-1" />
                ) : (
                  <AlertTriangle className="h-3 w-3 text-yellow-500 mr-1" />
                )}
                <span className="text-sm font-mono">
                  {performance.render.fps}fps
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center">
                {performance.load.isFast ? (
                  <CheckCircle className="h-3 w-3 text-green-500 mr-1" />
                ) : performance.load.isSlow ? (
                  <AlertTriangle className="h-3 w-3 text-red-500 mr-1" />
                ) : (
                  <AlertTriangle className="h-3 w-3 text-yellow-500 mr-1" />
                )}
                <span className="text-sm font-mono">
                  {performance.load.time.toFixed(0)}ms
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center">
                {performance.cache.isEfficient ? (
                  <CheckCircle className="h-3 w-3 text-green-500 mr-1" />
                ) : (
                  <AlertTriangle className="h-3 w-3 text-yellow-500 mr-1" />
                )}
                <span className="text-sm font-mono">
                  {(performance.cache.hitRate * 100).toFixed(1)}%
                </span>
              </div>
            </div>
          </div>
...
export const PerformanceOptimizer: React.FC = () => {
  const performance = usePerformanceSelectors()
  const { setPerformanceMode } = useAppActions()
  ...
  const suggestions = React.useMemo(() => {
    ...
    if (performance.memory.isHigh) {
      suggestions.push({
        ...
        action: () => setPerformanceMode(true),
        severity: 'high',
      })
    }
    ...
    return suggestions
  }, [performance, setPerformanceMode])
